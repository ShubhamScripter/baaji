...
export const loginAdmin = createAsyncThunk(
  ...
  async (userData, { rejectWithValue }) => {
    try {
      const response = await axios.post("/sub-admin/login", userData, {
...
export const getAdmin = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get("/sub-admin/getuserbyid", {
        withCredentials: true,
      });
      const data = response.data;
      return data;
...
export const updateCreditReference = createAsyncThunk(
  ...
  async (info, { rejectWithValue }) => {
    try {
      const response = await axios.put(`/update/user-details`, info, {
        withCredentials: true,
      });
      return response.data;
    } catch (error) {
...
export const updateExploserLimit = createAsyncThunk(
  ...
  async (info, { rejectWithValue }) => {
    try {
      const response = await axios.put(`/update/user-explosore-limit`, info, {
        withCredentials: true,
      });
      return response.data;
    } catch (error) {
...
export const withdrawalAndDeposite = createAsyncThunk(
  ...
  async (info, { rejectWithValue }) => {
    ...
    try {
      const response = await axios.put(`/withdrowal-deposite`, info, {
        withCredentials: true,
      });
      return response.data;
    } catch (error) {
...
export const userSetting = createAsyncThunk(
  ...
  async (info, { rejectWithValue }) => {
    // console.log("info", info)
    try {
      const response = await axios.put(`/user-setting`, info, {
        withCredentials: true,
      });
      return response.data;
    } catch (error) {
...
export const deleteSubAdmin = createAsyncThunk(
  ...
  async (userId, { rejectWithValue }) => {
    try {
      const response = await axios.delete(`/sub-admin/delete/${userId}`, {
        withCredentials: true,
      });
      return response.data;
    } catch (error) {
...
export const changePasswordBySelf = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    try {
      const response = await axios.post("/change/password-self", data, {
        withCredentials: true,
      });
      return response.data;
    } catch (error) {
...
export const changePasswordByDownline = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    try {
      const response = await axios.post("/change/password-downline", data, {
        withCredentials: true,
      });
      return response.data;
    } catch (error) {
...
export const getUserProfule = createAsyncThunk(
  ...
  async (userId, { rejectWithValue }) => {
    try {
      const res = await axios.get(`/get/user-profile/${userId}`, {
        withCredentials: true,
      });
      return res.data;
    } catch (error) {
...
export const getTranstionHistory = createAsyncThunk(
  ...
  async ({ page, limit, startDate, endDate }, { rejectWithValue }) => {
    try {
      ...
      const res = await axios.get(`/get/agent-trantionhistory${query}`, {
        withCredentials: true,
      });
      return res.data;
    } catch (error) {
...
export const geUserTrantionHistory = createAsyncThunk(
  ...
  async ({ userId, page, limit, startDate, endDate }, { rejectWithValue }) => {
    ...
    try {
      ...
      const res = await axios.get(`/get/user-trantion-history/${userId}${query}`, {
        withCredentials: true,
      });
      return res.data;
    } catch (error) {
...
//         query += `&startDate=${startDate}&endDate=${endDate}`;
//       }
//       const res = await axios.get(`/get/all-bet-list/${query}`, {
//         withCredentials: true,
//       });
//       return res.data;
//     } catch (error) {
...
export const geAllBetHistory = createAsyncThunk(
  "creditRef/getallbethistory",
  async ({ id, page, limit, startDate, endDate, selectedGame, selectedVoid }, { rejectWithValue }) => {
    try {
...
export const getBetPerents = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    ...
    try {
      ...
      const res = await axios.get(`/get/bet-perents/${id}`, {
        withCredentials: true,
      });
      return res.data;
    } catch (error) {
