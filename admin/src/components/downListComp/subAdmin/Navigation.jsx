    ...
    <div>
      <ul className="bg-[#fff] font-['Times_New_Roman'] ">
        ...
        onClick={()=>{
            ...
            navigate('/account-summary/senior_super')
        }}
        >
          Account Summary
        </li>
        ...
        onClick={()=>{
            navigate("/current-bets/senior_super")
        }}
        >
          Current Bets
        </li>
        ...
        onClick={()=>{
            navigate("/betting-history/senior_super")
        }}
        >
          Betting History
        </li>
        ...
        onClick={()=>{
            navigate("/betting-profit-loss/senior_super")
        }}
        >
          Betting Profit & Loss
        </li>
        ...
        onClick={()=>{
            navigate("/transaction-history/senior_super")
        }}
        >
          Transaction History
        </li>
        ...
        onClick={()=>{
            navigate("/activity-log/senior_super")
        }}
        >
          Activity Log
        </li>
