  ...
  return (
    <div>
      <ul className="bg-[#fff] font-['Times_New_Roman'] ">
        ...
        onClick={()=>{
            navigate("/betting-profit-loss/user")
        }}
        >
          Betting Profit & Loss
        </li>
        ...
        onClick={()=>{
            navigate("/transaction-history/user")
        }}
        >
          Transaction History
        </li>
