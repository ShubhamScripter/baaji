...
function UnMatchedTable({ bettingData }) {
  ...
  return (
    <div className="">
      <div className='bg-[#3b5160] border-b border-b-[#7e97a7] text-[#fff] min-w-full pl-2 text-sm'>UnMatched</div>
      <table className="min-w-full text-xs text-left">
        ...
        <tbody>
          {bettingData.length === 0 ? (
            <tr>
              <td colSpan="11" className="text-center py-4 text-[#3b5160] bg-[#0000000d] border-y border-[#7e97a7]">
