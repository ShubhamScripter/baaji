    ...
    try {
        ...
        for (const uId of ids) {
            ...
            if (user.role === "user") {
                ...
                console.log(`🎲 [CASINO MASTER BOOK] User ${user.userName} has ${userBets.length} casino bets`);
                ...
                console.log(`🎲 [CASINO MASTER BOOK] Agent ${user.userName} has ${bets.length} casino bets from downlines`);
        ...
        console.log("🎯 [CASINO MASTER BOOK] Final result:", result.length, "users");
...
export const getCasinoMasterBookDownline = async (req, res) => {
    ...
    console.log("🎰 [CASINO MASTER BOOK DOWNLINE] Starting with:", { gameId, gameType, userId });
    ...
    try {
        ...
        for (const uId of ids) {
            ...
            if (user.role === "user") {
                ...
                console.log(` [CASINO MASTER BOOK DOWNLINE] User ${user.userName} has ${userBets.length} casino bets`);
                ...
                console.log(`🎲 [CASINO MASTER BOOK DOWNLINE] Agent ${user.userName} has ${bets.length} casino bets from downlines`);
        ...
        console.log(" [CASINO MASTER BOOK DOWNLINE] Final result:", result.length, "users");
        ...
        console.error("[CASINO MASTER BOOK DOWNLINE] Error fetching casino bets:", error);
        return res.status(500).json({
            success: false,
            message: "Server error",
            error: error.message,
